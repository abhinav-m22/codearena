        ...
        <>
            <tbody className='text-white'>
                {problems.map((problem, index) => {
                    ...
                    const difficulty = problem.difficulty === "Easy" ? 'text-dark-green-s' : problem.difficulty === "Medium" ? "text-dark-yellow" : "text-dark-pink";
            ...
            {youtubePlayer.isOpen && (
                ...
                <tfoot className='fixed top-0 left-0 h-screen w-screen flex problems-center justify-center'>
                    ...
                    <div className='w-full z-50 h-full px-6 relative max-w-3xl'>
                        <div className='w-full h-full flex problems-center justify-center relative'>
                            <div className='w-full relative mt-10'>
                                <IoClose fontSize={"25"} className='cursor-pointer absolute -top-8 right-0' onClick={closeModal}/>
